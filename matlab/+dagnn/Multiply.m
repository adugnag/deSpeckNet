classdef Multiply < dagnn.ElementWise
  %MULTIPLY DagNN multiply layer
  %   The MULTIPLY layer takes the product of all its inputs and store the result
  %   as its only output.
  ...
  methods
    function outputs = forward(obj, inputs, params)
      ...
      %end
      outputs{1} = inputs{1} .* inputs{2} ;  %for clarity and for two stream network
